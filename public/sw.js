const CACHE='mocui-v4.4.2-ui-refine';
const SHELL=[
  './','./index.html','./offline.html','./app.css','./core-v4.css?v=4.0.1',
  './app-core-v4.1.4.js?v=4.1.4','./mocui-lite-v4.4.2.js?v=4.4.2',
  './mocui-lite-v4.4.2.css?v=4.4.2','./pwa.js?v=4.4.2','./manifest.webmanifest','./version.json'
];
