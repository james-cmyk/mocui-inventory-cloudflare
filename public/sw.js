const CACHE='mocui-v4.4.1-ui';
const SHELL=[
  './','./index.html','./offline.html','./app.css','./core-v4.css?v=4.0.1',
  './app-core-v4.1.4.js?v=4.1.4','./mocui-lite-v4.4.1.js?v=4.4.1',
  './mocui-lite-v4.4.1.css?v=4.4.1','./pwa.js?v=4.4.1','./manifest.webmanifest','./version.json'
];
...
// v4.4.1：压缩首页模块、补回今日利润、统一全站卡片/弹窗/按钮视觉；小红书订单显式渠道 + 客户信息自动识别。
